<div>
    ...
    <form wire:submit.prevent="update" class="card-body">
        ...
        <div class="form-group m-2">
            ...
            <input type="text" class="form-control" id="title" wire:model='title' placeholder="Post Title">
            @error('title') <span class="text-danger">{{ $message }}</span> @enderror
        </div>
        <div class="form-group m-2">
            <label for="body">Body</label>
            <textarea type="text" class="form-control" id="body" wire:model='body' placeholder="Post Body"></textarea>
